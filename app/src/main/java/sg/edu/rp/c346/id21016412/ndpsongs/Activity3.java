    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DBHelper dbh = new DBHelper(Activity3.this);
                ...
                try {
                    ...
                    Toast.makeText(Activity3.this, "Invalid year", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (result>0){
                    Toast.makeText(Activity3.this, "Song updated", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(Activity3.this, "Update failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result>0){
                    Toast.makeText(Activity3.this, "Song deleted", Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(Activity3.this, "Delete failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
